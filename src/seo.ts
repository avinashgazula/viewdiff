...
Ut enim ad minim veniam.`,
  ...
  },
  {
    slug: '/xml-diff',
    language: 'xml',
    title: 'Compare XML Files Online Free — XML Diff Checker | viewdiff',
    description:
      'Compare two XML files online with syntax highlighting and auto-formatting. Free XML diff tool — side-by-side comparison of config files, SOAP responses, and SVG. No sign-up, 100% private.',
    keywords:
      'xml diff, compare xml, xml compare, compare two xml files online, xml difference, xml diff tool, xml comparison, xml file compare, compare xml online, comparing xml files, xml compare online, compare xml files online, compare xml files, xml compare tool, xml diff online, xml diff checker, online xml compare, diff xml online, xml compare tools, xml comparator, xml comparison tool, compare two xml, xml file comparison, xml file compare online, xml file compare tool',
    h1: 'Compare XML files online',
    subtitle: 'Paste XML documents on each side and instantly see every difference highlighted with syntax coloring.',
    intro: 'Compare two XML files side-by-side and instantly see every difference. This free XML diff tool provides syntax highlighting, auto-formatting with Prettier, and color-coded diffs. Perfect for comparing configuration files, SOAP responses, SVG files, RSS feeds, or any XML data. viewdiff runs 100% in your browser — your XML documents are never uploaded to any server.',
...
<catalog>
  ...
  <book id="2">
    ...
    faq: [
      { q: 'How do I compare two XML files online?', a: 'Paste the original XML on the left and the modified XML on the right. viewdiff instantly highlights every difference — added elements in green, removed elements in red. No buttons to click, no sign-up needed.' },
      { q: 'Does it format XML before comparing?', a: 'Yes — click Format to auto-indent and pretty-print your XML with Prettier before comparing. This normalizes formatting so you only see meaningful differences.' },
      { q: 'Can I compare SOAP responses?', a: 'Yes. Paste any valid XML including SOAP responses, WSDL files, SVG markup, RSS feeds, Maven POM files, and configuration files.' },
      { q: 'Does it handle XML namespaces?', a: 'Yes — the syntax highlighter and diff engine handle namespaced XML, namespace prefixes, and xmlns declarations correctly.' },
      { q: 'Can I compare large XML files?', a: 'Yes. viewdiff uses the Monaco editor (same engine as VS Code) which handles large documents efficiently with virtualized rendering.' },
      { q: 'Is my XML data private?', a: 'Yes — viewdiff runs 100% client-side in your browser. Your XML documents are never uploaded to any server. Safe for comparing sensitive configuration files.' },
      { q: 'Can I ignore whitespace in XML comparisons?', a: 'Yes — use the Format button to normalize indentation, or toggle "Ignore whitespace" in Settings to hide formatting-only differences.' },
      { q: 'Is this XML diff tool free?', a: 'Yes, completely free with no ads, no account required, and no usage limits. Compare as many XML files as you want.' },
    ],
  },
  {
    slug: '/yaml-diff',
...
<body>
  ...
  },
  {
    slug: '/sql-diff',
    language: 'sql',
    title: 'Compare SQL Queries Online Free — SQL Diff Checker | viewdiff',
    description:
      'Compare two SQL queries, schemas, or migration files online with syntax highlighting. Free SQL diff tool — side-by-side comparison, no sign-up, 100% private. Works with PostgreSQL, MySQL, and SQLite.',
    keywords:
      'sql diff, compare sql, sql compare, compare two sql queries online, compare sql queries online, compare sql query online, sql difference, sql diff tool, sql comparison online, compare sql online, compare sql code online, sql query compare online, sql compare online, compare two sql files online, sql difference checker, diff sql, sql code compare online, database diff, compare stored procedures, sql file compare online, sql compare online free',
    h1: 'Compare SQL queries online',
    subtitle: 'Paste SQL queries on each side and instantly see every difference highlighted with syntax coloring.',
...
ORDER BY u.name ASC;`,
    ...
    faq: [
      { q: 'How do I compare two SQL queries online?', a: 'Paste the original SQL query on the left and the modified query on the right. viewdiff instantly highlights every difference — additions in green, deletions in red. No buttons to click.' },
      { q: 'Can I compare database migration files?', a: 'Yes — paste two migration files to see exactly what changed between versions. viewdiff highlights added columns, modified constraints, dropped tables, and every other change.' },
      { q: 'Does it support PostgreSQL, MySQL, and SQLite?', a: 'Yes. The syntax highlighter covers standard SQL and recognizes keywords from PostgreSQL, MySQL, SQLite, SQL Server, and Oracle.' },
      { q: 'Can I compare stored procedures?', a: 'Yes. Paste any SQL text including stored procedures, functions, triggers, views, and indexes to see differences highlighted with syntax coloring.' },
      { q: 'Is my SQL data private?', a: 'Yes — viewdiff runs 100% client-side in your browser. Your SQL queries are never uploaded to any server. Compare sensitive database schemas with confidence.' },
      { q: 'Can I compare SQL schema files?', a: 'Yes — paste CREATE TABLE, ALTER TABLE, or any DDL statements to compare schema changes side-by-side. Perfect for reviewing database migrations before deploying.' },
      { q: 'Is this SQL diff tool free?', a: 'Yes, completely free with no ads, no sign-up, and no usage limits. Compare as many SQL files as you need.' },
      { q: 'Can I ignore whitespace in SQL comparisons?', a: 'Yes — open Settings and toggle "Ignore whitespace" to hide formatting-only changes and focus on meaningful differences in your SQL code.' },
    ],
  },
  {
    slug: '/scss-diff',
